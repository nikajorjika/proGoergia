    ...
    <div class="row centered-form">
        <div class="centered-width text-align-left">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::file('annoucement', ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::file('extraction', ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('applicant', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('law_form', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('identification_number', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('address', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('contact_person', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('email', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('contact_telephone', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::select('field_id', with_empty($fields->toArray()), null, ['class' => 'field form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::textarea('comment', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('edu_program_name', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::textarea('edu_program_goal', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::textarea('edu_program_prelet', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('edu_program_goal_groups', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                @foreach($listener_numbers as $listener_number)
                    ...
                    {!! Form::radio('listenernumber_id',$listener_number->id, false, [$editable ? null : 'disabled']) !!}
                @endforeach
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        {!! Form::text('credit', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                    </div>
                    ...
                    <div class="col-sm-12">
                        {!! Form::text('contact_hours', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                    </div>
                    ...
                    <div class="col-sm-12">
                        {!! Form::text('free_hours', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::text('edu_program_results', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::textarea('program_short_desc', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::file('documentation', ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::file('plan', ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                @foreach($learn_methods as $learn_method)
                    ...
                    {!! Form::checkbox('learn_method[]',$learn_method->id, $checked, [$editable ? null : 'disabled']) !!}
                @endforeach

                {!! Form::textarea('learn_methods_other', null, ['class' => 'form-control input-sm ','placeholder' => 'სხვა', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                @foreach($estimations as $estimation)
                    ...
                    {!! Form::checkbox('estimation[]',$estimation->id, $checked, [$editable ? null : 'disabled']) !!}
                    {!! Form::text('min_'.$estimation->id, $min, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                    {!! Form::text('max_'.$estimation->id, $max, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                @endforeach

                {!! Form::textarea('estimations_other', null, ['class' => 'form-control input-sm ','placeholder' => 'სხვა', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                @foreach($certificaterules as $certificaterule)
                    ...
                    {!! Form::checkbox('certificaterule[]',$certificaterule -> id, $checked, [$editable ? null : 'disabled']) !!}
                    {!! Form::text('percentage_'.$certificaterule->id , $percentage, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                @endforeach

                {!! Form::textarea('certificate_rules_other', null, ['class' => 'form-control input-sm ', $editable ? null : 'disabled', 'placeholder' => 'სხვა']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::file('certificate', ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                @foreach($ratingsystems as $ratingsystem)
                    ...
                    {!! Form::radio('ratingsystem_id',$ratingsystem->id, false, [$editable ? null : 'disabled']) !!}
                @endforeach

                {!! Form::textarea('rating_system_other', null, ['class' => 'form-control input-sm', $editable ? null : 'disabled', 'placeholder' => 'სხვა']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::textarea('edu_program_human_resource', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::file('trainers', ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::textarea('trainers_contracts', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::textarea('edu_program_learn_env', null, ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::textarea('edu_program_learn_resources', null,['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                @foreach($learnmaterials as $learnmaterial)
                    ...
                    {!! Form::checkbox('learnmaterial[]',$learnmaterial->id, $checked, [$editable ? null : 'disabled']) !!}
                @endforeach

                {!! Form::textarea('learn_materials_other',null, ['class' => 'form-control input-sm', $editable ? null : 'disabled', 'placeholder' => 'Learn Materials სხვა ']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::file('bill', ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                ...
                <div class="col-sm-12">
                    {!! Form::file('materials', ['class' => 'form-control', $editable ? null : 'disabled']) !!}
                </div>
            </div>
