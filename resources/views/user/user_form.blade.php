    ...
    <div class="row centered-form">
        <div class="centered-width text-align-left">
            <h3 class="heading-title">
                ადგილობრივი თვითმართველობის მოხელეთა უწყვეტი
            ...
            <div class="form-group form-group-style  {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('annoucement', 'ატვირთეთ განცხადება(pdf ფორმატი):', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('extraction', 'ატვირთეთ ამონაწერი(pdf ფორმატი): ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('applicant', 'განმცხადებელი: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('law_form', 'სამართლებრივი ფორმა: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('identification_number', 'საიდენთიფიკაციო ნომერი: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('address', 'მისამართი: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('contact_person', 'საკონტაქტო პირი: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('email', 'ელექტრონული ფოსტა: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('contact_telephone', 'საკონტაქტო ტელეფონი: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('field_id', 'აირჩიეთ სფერო: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <?php $editable = in_array('term', $editables) ? true : false; ?>
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('term_id', 'აირჩიეთ ფორმა: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
                    {!! Form::select('term_id', with_empty($terms->toArray()), null, ['class' => 'term form-control', ($type == 'add' || $editable) ? null : 'disabled']) !!}
                </div>
            </div>

            <?php $editable = in_array('edu_program_name', $editables) ? true : false; ?>
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('edu_program_name', 'სასწავლო პროგრამის დასახელება: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('edu_program_goal', 'სასწავლო პროგრამის მიზანი: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('edu_program_prelet', 'სასწავლო პროგრამაზე დაშვების წინაპირობა: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('edu_program_goal_groups', 'სასწავლო პროგრამის მიზნობრივი ჯგუფი/ჯგუფები: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('listenernumber_id', 'სასწავლო პროგრამის მსმენელთა მინიმალური და მაქსიმალური რაოდენობა: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('', 'სასწავლო პროგრამის მოცულობა: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('edu_program_results', 'პროგრამის სწავლის შედეგები (ცოდნა და უნარ-ჩვევები): ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('program_short_desc', 'პროგრამის მოკლე აღწერა  და მისი შემადგენელი ძირითადი თემების ჩამონათვალი (შედგენილი უნდა იყოს  მეთოდოლოგიით, რომელიც აკმაყოფილებს ცენტრის მიერ დადგენილ შესაბამის მოთხოვნებს: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('documentation', 'პროგრამის შემუშავების ანგარიში და დამადასტურებელი დოკუმენტაცია -  დანართი №1(pdf ფორმატი): ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('plan', 'სასწავლო გეგმა  - დანართი №2(pdf ფორმატი): ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('learn_method', 'სასწავლო პროგრამის სწავლების მეთოდები და ორგანიზების ფორმა: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
                <?php $checked = false; ?>
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label(null, 'სასწავლო პროგრამის მონაწილეთა შეფასების მეთოდის/მეთოდები (მონიშნეთ). მიუთითეთ შესაბამისი შეფასების მინიმალური და მაქსიმალური ქულა: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('certificaterule[]', 'სერტიფიკატის გაცემის წესი და პირობები: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('certificate', 'სერტიფიკატის ფორმის ნიმუში - დანართი №3(pdf ფორმატი): ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('ratingsystem', 'სასწავლო პროგრამის შეფასების სისტემა: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('edu_program_human_resource', 'სასწავლო პროგრამის ადამიანური რესურსი - მწვრთნელის/მწვრთნელების ჩამონათვალი: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('trainers', 'მწვრთნელის/მწვრთნელების  კვალიფიკაციის დამადასტურებელი დოკუმენტები, დანართი №4(pdf ფორმატი): ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('trainers_contracts', 'მწვრთნელებთან გაფორმებული ხელშეკრულებები: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('edu_program_learn_env', 'პროგრამის განხორციელებისთვის აუცილებელი სასწავლო გარემო: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('edu_program_learn_resources', 'პროგრამის განხორციელებისთვის აუცილებელი სასწავლო რესურსის ჩამონათვალი: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label(null, 'პროგრამის განხორციელებისთვის არსებული სასწავლო მასალის ჩამონათვალი  - გამოყენებული ლიტერატურის საძიებო ლინკები, საკითხავი მასალა, ჰენდაუტები  და ა.შ.: ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
                <?php $checked = false; ?>
                ...
                {!! Form::textarea('learn_materials_other',null, ['class' => 'form-control input-sm', ($type == 'add' || $editable) ? null : 'disabled', 'placeholder' => 'სხვა ']) !!}
                </div>
            </div>

            <?php $editable = in_array('qvitari', $editables) ? true : false; ?>
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('bill', 'ატვირთეთ გადახდის ქვითარი(pdf ფორმატი): ', ['class' => 'col-sm-12 control-label','class' => 'required']) !!}
                <div class="col-sm-12">
            ...
            <div class="form-group form-group-style {{ $editable ? 'editable' : 'not-editable' }}">
                {!! Form::label('materials', 'იმ საკითხავი მასალის ნიმუშები, რომლებიც არ არის საყოველთაოდ ხელმისაწვდომი,  დანართი №5(pdf ფორმატი): ', ['class' => 'col-sm-12 control-label']) !!}
                <div class="col-sm-12">
                    {!! Form::file('materials', ['class' => 'form-control', ($type == 'add' || $editable) ? null : 'disabled']) !!}
                </div>
            </div>
            <div class="form-group form-group-style " style="padding-left: 20px;margin-bottom: 20px;">
               {!! Form::checkbox('prevent') !!}
                {!! Form::label('null','პასუხს ვაგებ მოწოდებული ინფორმაციის სისწორეზე',['class' => 'required']) !!}
            </div>
